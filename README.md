...
- [Table of Contents](#table-of-contents)
  ...
  - [API documentation generation (annex)](#api-documentation-generation-annex)
- [Sources](#sources)
...
API documentation is generated by **Spring REST Docs** from MockMvc integration tests, then assembled into HTML by Asciidoctor during `mvn package`.
...
- HTML (repo): [docs/index.html](docs/index.html)
...
**[docs/api-documentation-generation.md](docs/api-documentation-generation.md)**

Draw.io source: [docs/process/restdocs-generation.drawio](docs/process/restdocs-generation.drawio)
