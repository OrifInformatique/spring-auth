...
... <<Error Response - 401 - Promote User to Manager>>
..... <<Missing Authorization Header - Promote User to Manager>>
..... <<Malformed Token - Promote User to Manager>>
... <<Error Response - 403 - Promote User to Manager>>
..... <<Non-Admin User - Promote User to Manager>>
