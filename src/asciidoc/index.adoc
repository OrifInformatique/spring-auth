...
.request
include::auth/refresh-missing-token/http-request.adoc[]

.response
include::auth/refresh-missing-token/http-response.adoc[]
...
.request
include::auth/refresh-empty-body/http-request.adoc[]

.response
include::auth/refresh-empty-body/http-response.adoc[]
...
.request
include::auth/logout-malformed-token/http-request.adoc[]

.response
include::auth/logout-malformed-token/http-response.adoc[]
...
This is an example output for the `PUT /users/{userLogin}/promote-manager` endpoint.
...
These are example outputs for the `PUT /users/{userLogin}/promote-manager` endpoint for unauthorized access.
...
These are example outputs for the `PUT /users/{userLogin}/promote-manager` endpoint for forbidden access.
...
These are example outputs for the `PUT /users/{userLogin}/promote-manager` endpoint for not found errors.
...
These are example outputs for the `PUT /users/{userLogin}/promote-manager` endpoint for conflict errors.
...
This is an example output for the `PUT /users/{userLogin}/revoke-manager` endpoint.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-manager` endpoint for unauthorized access.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-manager` endpoint for forbidden access.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-manager` endpoint
...
This is an example output for the `PUT /users/{userLogin}/promote-admin` endpoint.
...
These are example outputs for the `PUT /users/{userLogin}/promote-admin` endpoint for unauthorized access.
...
These are example outputs for the `PUT /users/{userLogin}/promote-admin` endpoint for forbidden access.
...
These are example outputs for the `PUT /users/{userLogin}/promote-admin` endpoint for not found errors.
...
These are example outputs for the `PUT /users/{userLogin}/promote-admin` endpoint for conflict errors.
...
This is an example output for the `PUT /users/{userLogin}/revoke-admin` endpoint.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-admin` endpoint for unauthorized access.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-admin` endpoint for forbidden access.
...
These are example outputs for the `PUT /users/{userLogin}/revoke-admin` endpoint for not found errors.
...
This is an example output for the `PUT /users/{userLogin}/downgrade-admin` endpoint.
...
These are example outputs for the `PUT /users/{userLogin}/downgrade-admin` endpoint for unauthorized access.
...
=== 2.10 Delete User
This is an example output for the `DELETE /users/{userLogin}/0` endpoint.
...
These are example outputs for the `DELETE /users/{userLogin}/0` endpoint for unauthorized access.
...
This is an example output for the `DELETE /users/{userLogin}/0` endpoint - soft delete.

.request
include::users/delete-for-restore/http-request.adoc[]

.response
include::users/delete-for-restore/http-response.adoc[]

It soft-deletes a user, allowing them to be restored later.

=== 2.12 Permanently Delete User
This is an example output for the `DELETE /users/{userLogin}/1` endpoint.

.request
include::users/delete-permanent/http-request.adoc[]

.response
include::users/delete-permanent/http-response.adoc[]

It permanently deletes a user from the database.

=== 2.13 Restore Deleted User
This is an example output for the `PUT /users/{userLogin}/restore` endpoint.

.request
include::users/restore/http-request.adoc[]

.response
include::users/restore/http-response.adoc[]
